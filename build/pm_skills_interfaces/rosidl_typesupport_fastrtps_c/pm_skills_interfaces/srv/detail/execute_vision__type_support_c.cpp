...
#include "pm_skills_interfaces/srv/detail/execute_vision__rosidl_typesupport_fastrtps_c.h"
...
using _ExecuteVision_Request__ros_msg_type = pm_skills_interfaces__srv__ExecuteVision_Request;
...
size_t get_serialized_size_pm_skills_interfaces__srv__ExecuteVision_Request(
  const void * untyped_ros_message,
...
static uint32_t _ExecuteVision_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pm_skills_interfaces__srv__ExecuteVision_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pm_skills_interfaces
size_t max_serialized_size_pm_skills_interfaces__srv__ExecuteVision_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pm_skills_interfaces__srv__ExecuteVision_Request;
    is_plain =
      (
...
static size_t _ExecuteVision_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pm_skills_interfaces__srv__ExecuteVision_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pm_skills_interfaces, srv, ExecuteVision_Request)() {
...
// already included above
// #include "rosidl_runtime_c/string.h"  // process_uid, results_dict, results_path
// already included above
// #include "rosidl_runtime_c/string_functions.h"  // process_uid, results_dict, results_path

// forward declare type support functions


using _ExecuteVision_Response__ros_msg_type = pm_skills_interfaces__srv__ExecuteVision_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: results_dict
  {
    const rosidl_runtime_c__String * str = &ros_message->results_dict;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: results_dict
  {
    ...
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->results_dict,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'results_dict'\n");
      return false;
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pm_skills_interfaces
size_t get_serialized_size_pm_skills_interfaces__srv__ExecuteVision_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteVision_Response__ros_msg_type * ros_message = static_cast<const _ExecuteVision_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
    (ros_message->results_dict.size + 1);
  // field.name results_path
  current_alignment += padding +
    eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
...
{
  return static_cast<uint32_t>(
    get_serialized_size_pm_skills_interfaces__srv__ExecuteVision_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pm_skills_interfaces
size_t max_serialized_size_pm_skills_interfaces__srv__ExecuteVision_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pm_skills_interfaces__srv__ExecuteVision_Response;
    is_plain =
      (
      offsetof(DataType, process_uid) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ExecuteVision_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pm_skills_interfaces__srv__ExecuteVision_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pm_skills_interfaces, srv, ExecuteVision_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pm_skills_interfaces, srv, ExecuteVision)() {
