...
static const _CheckFrameMeasurable_Request_type_support_symbol_names_t _CheckFrameMeasurable_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pm_skills_interfaces, srv, CheckFrameMeasurable_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pm_skills_interfaces, srv, CheckFrameMeasurable_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pm_skills_interfaces, srv, CheckFrameMeasurable_Request)() {
  return &::pm_skills_interfaces::srv::rosidl_typesupport_c::CheckFrameMeasurable_Request_message_type_support_handle;
}
...
static const _CheckFrameMeasurable_Response_type_support_symbol_names_t _CheckFrameMeasurable_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pm_skills_interfaces, srv, CheckFrameMeasurable_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pm_skills_interfaces, srv, CheckFrameMeasurable_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pm_skills_interfaces, srv, CheckFrameMeasurable_Response)() {
  return &::pm_skills_interfaces::srv::rosidl_typesupport_c::CheckFrameMeasurable_Response_message_type_support_handle;
}
...
static const _CheckFrameMeasurable_type_support_symbol_names_t _CheckFrameMeasurable_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pm_skills_interfaces, srv, CheckFrameMeasurable)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pm_skills_interfaces, srv, CheckFrameMeasurable)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, pm_skills_interfaces, srv, CheckFrameMeasurable)() {
  return &::pm_skills_interfaces::srv::rosidl_typesupport_c::CheckFrameMeasurable_service_type_support_handle;
}
