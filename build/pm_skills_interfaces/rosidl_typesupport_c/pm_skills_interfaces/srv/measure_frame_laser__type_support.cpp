...
static const _MeasureFrameLaser_Request_type_support_symbol_names_t _MeasureFrameLaser_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pm_skills_interfaces, srv, MeasureFrameLaser_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pm_skills_interfaces, srv, MeasureFrameLaser_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pm_skills_interfaces, srv, MeasureFrameLaser_Request)() {
  return &::pm_skills_interfaces::srv::rosidl_typesupport_c::MeasureFrameLaser_Request_message_type_support_handle;
}
...
static const _MeasureFrameLaser_Response_type_support_symbol_names_t _MeasureFrameLaser_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pm_skills_interfaces, srv, MeasureFrameLaser_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pm_skills_interfaces, srv, MeasureFrameLaser_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pm_skills_interfaces, srv, MeasureFrameLaser_Response)() {
  return &::pm_skills_interfaces::srv::rosidl_typesupport_c::MeasureFrameLaser_Response_message_type_support_handle;
}
...
static const _MeasureFrameLaser_type_support_symbol_names_t _MeasureFrameLaser_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pm_skills_interfaces, srv, MeasureFrameLaser)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pm_skills_interfaces, srv, MeasureFrameLaser)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, pm_skills_interfaces, srv, MeasureFrameLaser)() {
  return &::pm_skills_interfaces::srv::rosidl_typesupport_c::MeasureFrameLaser_service_type_support_handle;
}
