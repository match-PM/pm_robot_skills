...
{
// message class
public class MeasureFrameVision_Request : MessageInternals, Message
{
  ...
  public System.String Vision_process_file_name { get; set; }
  ...
  [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
  private delegate IntPtr NativeReadFieldVision_process_file_nameType(IntPtr messageHandle);

  [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
  private delegate void NativeWriteFieldVision_process_file_nameType(
    IntPtr messageHandle, [MarshalAs (UnmanagedType.LPStr)] string value);


  private static NativeReadFieldVision_process_file_nameType native_read_field_vision_process_file_name = null;
  private static NativeWriteFieldVision_process_file_nameType native_write_field_vision_process_file_name = null;
  ...
  static MeasureFrameVision_Request()
  {
    ...
    IntPtr nativelibrary = dllLoadUtils.LoadLibrary("pm_skills_interfaces_srv_measure_frame_vision__rosidl_typesupport_c");
    IntPtr native_get_typesupport_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Request_native_get_type_support");
    MeasureFrameVision_Request.native_get_typesupport = (NativeGetTypeSupportType)Marshal.GetDelegateForFunctionPointer(
      native_get_typesupport_ptr, typeof(NativeGetTypeSupportType));

    IntPtr native_create_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Request_native_create_native_message");
    MeasureFrameVision_Request.native_create_native_message = (NativeCreateNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_create_native_message_ptr, typeof(NativeCreateNativeMessageType));

    IntPtr native_destroy_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Request_native_destroy_native_message");
    MeasureFrameVision_Request.native_destroy_native_message = (NativeDestroyNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_destroy_native_message_ptr, typeof(NativeDestroyNativeMessageType));

    IntPtr native_read_field_frame_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Request_native_read_field_frame_name");
    MeasureFrameVision_Request.native_read_field_frame_name =
    ...
    IntPtr native_write_field_frame_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Request_native_write_field_frame_name");
    MeasureFrameVision_Request.native_write_field_frame_name =
    ...
    IntPtr native_read_field_vision_process_file_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Request_native_read_field_vision_process_file_name");
    MeasureFrameVision_Request.native_read_field_vision_process_file_name =
      (NativeReadFieldVision_process_file_nameType)Marshal.GetDelegateForFunctionPointer(
      native_read_field_vision_process_file_name_ptr, typeof(NativeReadFieldVision_process_file_nameType));

    IntPtr native_write_field_vision_process_file_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Request_native_write_field_vision_process_file_name");
    MeasureFrameVision_Request.native_write_field_vision_process_file_name =
      (NativeWriteFieldVision_process_file_nameType)Marshal.GetDelegateForFunctionPointer(
      native_write_field_vision_process_file_name_ptr, typeof(NativeWriteFieldVision_process_file_nameType));
  }
  ...
  public MeasureFrameVision_Request()
  {
    Frame_name = "";
  ...
  public void ReadNativeMessage(IntPtr handle)
  {
    ...
    {
      IntPtr pStr = native_read_field_vision_process_file_name(handle);
      Vision_process_file_name = Marshal.PtrToStringAnsi(pStr);
    }
  }
  ...
  public void WriteNativeMessage(IntPtr handle)
  {
    ...
    native_write_field_vision_process_file_name(handle, Vision_process_file_name);
  }
  ...
  ~MeasureFrameVision_Request()
  {
    Dispose();
  }

};  // class MeasureFrameVision_Request
}  // namespace srv
}  // namespace pm_skills_interfaces
...
{
// message class
public class MeasureFrameVision_Response : MessageInternals, Message
{
  private IntPtr _handle;
  private static readonly DllLoadUtils dllLoadUtils;
  ...
  static MeasureFrameVision_Response()
  {
    Ros2csLogger logger = Ros2csLogger.GetInstance();
    ...
    IntPtr nativelibrary = dllLoadUtils.LoadLibrary("pm_skills_interfaces_srv_measure_frame_vision__rosidl_typesupport_c");
    IntPtr native_get_typesupport_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Response_native_get_type_support");
    MeasureFrameVision_Response.native_get_typesupport = (NativeGetTypeSupportType)Marshal.GetDelegateForFunctionPointer(
      native_get_typesupport_ptr, typeof(NativeGetTypeSupportType));

    IntPtr native_create_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Response_native_create_native_message");
    MeasureFrameVision_Response.native_create_native_message = (NativeCreateNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_create_native_message_ptr, typeof(NativeCreateNativeMessageType));

    IntPtr native_destroy_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Response_native_destroy_native_message");
    MeasureFrameVision_Response.native_destroy_native_message = (NativeDestroyNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_destroy_native_message_ptr, typeof(NativeDestroyNativeMessageType));

    IntPtr native_read_field_success_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Response_native_read_field_success");
    MeasureFrameVision_Response.native_read_field_success =
    ...
    IntPtr native_write_field_success_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Response_native_write_field_success");
    MeasureFrameVision_Response.native_write_field_success =
    ...
    IntPtr native_get_nested_message_handle_result_vector_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Response_native_get_nested_message_handle_result_vector");
    MeasureFrameVision_Response.native_get_nested_message_handle_result_vector =
    ...
    IntPtr native_read_field_message_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Response_native_read_field_message");
    MeasureFrameVision_Response.native_read_field_message =
    ...
    IntPtr native_write_field_message_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Response_native_write_field_message");
    MeasureFrameVision_Response.native_write_field_message =
    ...
    IntPtr native_get_nested_message_handle_vision_response_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Response_native_get_nested_message_handle_vision_response");
    MeasureFrameVision_Response.native_get_nested_message_handle_vision_response =
    ...
    IntPtr native_read_field_component_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Response_native_read_field_component_name");
    MeasureFrameVision_Response.native_read_field_component_name =
    ...
    IntPtr native_write_field_component_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Response_native_write_field_component_name");
    MeasureFrameVision_Response.native_write_field_component_name =
    ...
    IntPtr native_read_field_component_uuid_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Response_native_read_field_component_uuid");
    MeasureFrameVision_Response.native_read_field_component_uuid =
    ...
    IntPtr native_write_field_component_uuid_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__MeasureFrameVision_Response_native_write_field_component_uuid");
    MeasureFrameVision_Response.native_write_field_component_uuid =
  ...
  public MeasureFrameVision_Response()
  {
  ...
  ~MeasureFrameVision_Response()
  {
    Dispose();
  }

};  // class MeasureFrameVision_Response
}  // namespace srv
}  // namespace pm_skills_interfaces
