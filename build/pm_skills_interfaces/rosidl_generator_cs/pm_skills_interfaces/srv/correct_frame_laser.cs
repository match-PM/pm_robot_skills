...
{
// message class
public class CorrectFrameLaser_Request : MessageInternals, Message
{
  ...
  public bool Use_iterative_sensing { get; set; }
  ...
  [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
  private delegate bool NativeReadFieldUse_iterative_sensingType(
    IntPtr messageHandle);

  [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
  private delegate void NativeWriteFieldUse_iterative_sensingType(
    IntPtr messageHandle, bool value);


  private static NativeReadFieldUse_iterative_sensingType native_read_field_use_iterative_sensing = null;
  private static NativeWriteFieldUse_iterative_sensingType native_write_field_use_iterative_sensing = null;
  ...
  static CorrectFrameLaser_Request()
  {
    ...
    IntPtr nativelibrary = dllLoadUtils.LoadLibrary("pm_skills_interfaces_srv_correct_frame_laser__rosidl_typesupport_c");
    IntPtr native_get_typesupport_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Request_native_get_type_support");
    CorrectFrameLaser_Request.native_get_typesupport = (NativeGetTypeSupportType)Marshal.GetDelegateForFunctionPointer(
      native_get_typesupport_ptr, typeof(NativeGetTypeSupportType));

    IntPtr native_create_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Request_native_create_native_message");
    CorrectFrameLaser_Request.native_create_native_message = (NativeCreateNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_create_native_message_ptr, typeof(NativeCreateNativeMessageType));

    IntPtr native_destroy_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Request_native_destroy_native_message");
    CorrectFrameLaser_Request.native_destroy_native_message = (NativeDestroyNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_destroy_native_message_ptr, typeof(NativeDestroyNativeMessageType));

    IntPtr native_read_field_frame_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Request_native_read_field_frame_name");
    CorrectFrameLaser_Request.native_read_field_frame_name =
    ...
    IntPtr native_write_field_frame_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Request_native_write_field_frame_name");
    CorrectFrameLaser_Request.native_write_field_frame_name =
    ...
    IntPtr native_read_field_remeasure_after_correction_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Request_native_read_field_remeasure_after_correction");
    CorrectFrameLaser_Request.native_read_field_remeasure_after_correction =
    ...
    IntPtr native_write_field_remeasure_after_correction_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Request_native_write_field_remeasure_after_correction");
    CorrectFrameLaser_Request.native_write_field_remeasure_after_correction =
    ...
    IntPtr native_read_field_use_iterative_sensing_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Request_native_read_field_use_iterative_sensing");
    CorrectFrameLaser_Request.native_read_field_use_iterative_sensing =
      (NativeReadFieldUse_iterative_sensingType)Marshal.GetDelegateForFunctionPointer(
      native_read_field_use_iterative_sensing_ptr, typeof(NativeReadFieldUse_iterative_sensingType));

    IntPtr native_write_field_use_iterative_sensing_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Request_native_write_field_use_iterative_sensing");
    CorrectFrameLaser_Request.native_write_field_use_iterative_sensing =
      (NativeWriteFieldUse_iterative_sensingType)Marshal.GetDelegateForFunctionPointer(
      native_write_field_use_iterative_sensing_ptr, typeof(NativeWriteFieldUse_iterative_sensingType));
  }
  ...
  public CorrectFrameLaser_Request()
  {
    Frame_name = "";
  }
  ...
  public void ReadNativeMessage(IntPtr handle)
  {
    ...
    Use_iterative_sensing = native_read_field_use_iterative_sensing(handle);
  }
  ...
  public void WriteNativeMessage(IntPtr handle)
  {
    ...
    native_write_field_use_iterative_sensing(handle, Use_iterative_sensing);
  }
  ...
  ~CorrectFrameLaser_Request()
  {
    Dispose();
  }

};  // class CorrectFrameLaser_Request
}  // namespace srv
}  // namespace pm_skills_interfaces
...
{
// message class
public class CorrectFrameLaser_Response : MessageInternals, Message
{
  private IntPtr _handle;
  private static readonly DllLoadUtils dllLoadUtils;
  ...
  static CorrectFrameLaser_Response()
  {
    Ros2csLogger logger = Ros2csLogger.GetInstance();
    ...
    IntPtr nativelibrary = dllLoadUtils.LoadLibrary("pm_skills_interfaces_srv_correct_frame_laser__rosidl_typesupport_c");
    IntPtr native_get_typesupport_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Response_native_get_type_support");
    CorrectFrameLaser_Response.native_get_typesupport = (NativeGetTypeSupportType)Marshal.GetDelegateForFunctionPointer(
      native_get_typesupport_ptr, typeof(NativeGetTypeSupportType));

    IntPtr native_create_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Response_native_create_native_message");
    CorrectFrameLaser_Response.native_create_native_message = (NativeCreateNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_create_native_message_ptr, typeof(NativeCreateNativeMessageType));

    IntPtr native_destroy_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Response_native_destroy_native_message");
    CorrectFrameLaser_Response.native_destroy_native_message = (NativeDestroyNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_destroy_native_message_ptr, typeof(NativeDestroyNativeMessageType));

    IntPtr native_read_field_success_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Response_native_read_field_success");
    CorrectFrameLaser_Response.native_read_field_success =
    ...
    IntPtr native_write_field_success_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Response_native_write_field_success");
    CorrectFrameLaser_Response.native_write_field_success =
    ...
    IntPtr native_get_nested_message_handle_correction_values_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Response_native_get_nested_message_handle_correction_values");
    CorrectFrameLaser_Response.native_get_nested_message_handle_correction_values =
    ...
    IntPtr native_read_field_message_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Response_native_read_field_message");
    CorrectFrameLaser_Response.native_read_field_message =
    ...
    IntPtr native_write_field_message_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Response_native_write_field_message");
    CorrectFrameLaser_Response.native_write_field_message =
    ...
    IntPtr native_read_field_component_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Response_native_read_field_component_name");
    CorrectFrameLaser_Response.native_read_field_component_name =
    ...
    IntPtr native_write_field_component_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Response_native_write_field_component_name");
    CorrectFrameLaser_Response.native_write_field_component_name =
    ...
    IntPtr native_read_field_component_uuid_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Response_native_read_field_component_uuid");
    CorrectFrameLaser_Response.native_read_field_component_uuid =
    ...
    IntPtr native_write_field_component_uuid_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CorrectFrameLaser_Response_native_write_field_component_uuid");
    CorrectFrameLaser_Response.native_write_field_component_uuid =
  ...
  public CorrectFrameLaser_Response()
  {
  ...
  ~CorrectFrameLaser_Response()
  {
    Dispose();
  }

};  // class CorrectFrameLaser_Response
}  // namespace srv
}  // namespace pm_skills_interfaces
