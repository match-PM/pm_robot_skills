...
{
// message class
public class CheckFrameMeasurable_Request : MessageInternals, Message
{
  ...
  static CheckFrameMeasurable_Request()
  {
    ...
    IntPtr nativelibrary = dllLoadUtils.LoadLibrary("pm_skills_interfaces_srv_check_frame_measurable__rosidl_typesupport_c");
    IntPtr native_get_typesupport_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CheckFrameMeasurable_Request_native_get_type_support");
    CheckFrameMeasurable_Request.native_get_typesupport = (NativeGetTypeSupportType)Marshal.GetDelegateForFunctionPointer(
      native_get_typesupport_ptr, typeof(NativeGetTypeSupportType));

    IntPtr native_create_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CheckFrameMeasurable_Request_native_create_native_message");
    CheckFrameMeasurable_Request.native_create_native_message = (NativeCreateNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_create_native_message_ptr, typeof(NativeCreateNativeMessageType));

    IntPtr native_destroy_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CheckFrameMeasurable_Request_native_destroy_native_message");
    CheckFrameMeasurable_Request.native_destroy_native_message = (NativeDestroyNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_destroy_native_message_ptr, typeof(NativeDestroyNativeMessageType));

    IntPtr native_read_field_frame_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CheckFrameMeasurable_Request_native_read_field_frame_name");
    CheckFrameMeasurable_Request.native_read_field_frame_name =
    ...
    IntPtr native_write_field_frame_name_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CheckFrameMeasurable_Request_native_write_field_frame_name");
    CheckFrameMeasurable_Request.native_write_field_frame_name =
  ...
  public CheckFrameMeasurable_Request()
  {
    Frame_name = "";
  }
...
};  // class CheckFrameMeasurable_Request
}  // namespace srv
}  // namespace pm_skills_interfaces
...
{
// message class
public class CheckFrameMeasurable_Response : MessageInternals, Message
{
  private IntPtr _handle;
  private static readonly DllLoadUtils dllLoadUtils;
  ...
  static CheckFrameMeasurable_Response()
  {
    Ros2csLogger logger = Ros2csLogger.GetInstance();
    ...
    IntPtr nativelibrary = dllLoadUtils.LoadLibrary("pm_skills_interfaces_srv_check_frame_measurable__rosidl_typesupport_c");
    IntPtr native_get_typesupport_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CheckFrameMeasurable_Response_native_get_type_support");
    CheckFrameMeasurable_Response.native_get_typesupport = (NativeGetTypeSupportType)Marshal.GetDelegateForFunctionPointer(
      native_get_typesupport_ptr, typeof(NativeGetTypeSupportType));

    IntPtr native_create_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CheckFrameMeasurable_Response_native_create_native_message");
    CheckFrameMeasurable_Response.native_create_native_message = (NativeCreateNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_create_native_message_ptr, typeof(NativeCreateNativeMessageType));

    IntPtr native_destroy_native_message_ptr = dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CheckFrameMeasurable_Response_native_destroy_native_message");
    CheckFrameMeasurable_Response.native_destroy_native_message = (NativeDestroyNativeMessageType)Marshal.GetDelegateForFunctionPointer(
      native_destroy_native_message_ptr, typeof(NativeDestroyNativeMessageType));

    IntPtr native_read_field_success_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CheckFrameMeasurable_Response_native_read_field_success");
    CheckFrameMeasurable_Response.native_read_field_success =
    ...
    IntPtr native_write_field_success_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CheckFrameMeasurable_Response_native_write_field_success");
    CheckFrameMeasurable_Response.native_write_field_success =
    ...
    IntPtr native_read_field_message_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CheckFrameMeasurable_Response_native_read_field_message");
    CheckFrameMeasurable_Response.native_read_field_message =
    ...
    IntPtr native_write_field_message_ptr =
      dllLoadUtils.GetProcAddress(nativelibrary, "pm_skills_interfaces__srv__CheckFrameMeasurable_Response_native_write_field_message");
    CheckFrameMeasurable_Response.native_write_field_message =
  ...
  public CheckFrameMeasurable_Response()
  {
    Message = "";
  }
...
};  // class CheckFrameMeasurable_Response
}  // namespace srv
}  // namespace pm_skills_interfaces
