...
#include "pm_skills_interfaces/srv/detail/execute_vision__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pm_skills_interfaces::srv::ExecuteVision_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pm_skills_interfaces::srv::ExecuteVision_Request & ros_message)
{
  // Member: process_filename
  cdr >> ros_message.process_filename;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pm_skills_interfaces::srv::ExecuteVision_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pm_skills_interfaces::srv::ExecuteVision_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pm_skills_interfaces::srv::ExecuteVision_Request *>(
    untyped_ros_message);
...
{
  return &pm_skills_interfaces::srv::typesupport_fastrtps_cpp::_ExecuteVision_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pm_skills_interfaces, srv, ExecuteVision_Request)() {
  return &pm_skills_interfaces::srv::typesupport_fastrtps_cpp::_ExecuteVision_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pm_skills_interfaces
cdr_serialize(
  const pm_skills_interfaces::srv::ExecuteVision_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
  cdr << (ros_message.success ? true : false);
  // Member: results_dict
  cdr << ros_message.results_dict;
  // Member: results_path
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pm_skills_interfaces::srv::ExecuteVision_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = pm_skills_interfaces::srv::ExecuteVision_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pm_skills_interfaces::srv::ExecuteVision_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<pm_skills_interfaces::srv::ExecuteVision_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &pm_skills_interfaces::srv::typesupport_fastrtps_cpp::_ExecuteVision_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pm_skills_interfaces, srv, ExecuteVision_Response)() {
  return &pm_skills_interfaces::srv::typesupport_fastrtps_cpp::_ExecuteVision_Response__handle;
}
...
{
  return &pm_skills_interfaces::srv::typesupport_fastrtps_cpp::_ExecuteVision__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pm_skills_interfaces, srv, ExecuteVision)() {
  return &pm_skills_interfaces::srv::typesupport_fastrtps_cpp::_ExecuteVision__handle;
}
